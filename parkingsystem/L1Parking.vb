...
Public Class L1Parking
    ...
    Private Sub L1Parking_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-01'"
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-02'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-03'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-04'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-05'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-06'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-07'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-08'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-09'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-10'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-11'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-12 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-13 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-14 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-15 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-16 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-17'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-18 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-19 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-20 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-21 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-22 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-23 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-24 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-25 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-26 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-27 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-28 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-29 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-30'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-31'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-32'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-33 '"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-34'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-35'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-36'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-37'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-38'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-39'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-40'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-41'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-42'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-43'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-44'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-45'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-46'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-47'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-48'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-49'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
        ...
        con = New SqlConnection("Data Source=DESKTOP-GP9L71N\SQLEXPRESS;Initial Catalog=ParkingSystem;Integrated Security=True")
        con.Open()
        sql = "SELECT Status FROM Slots WHERE Slot_Id ='Lv1-50'"
        cmd = New SqlCommand(sql, con)
        dr = cmd.ExecuteReader
        dr.Read()
        a = dr.Item("Status")
